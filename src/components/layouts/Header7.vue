      ...
      <header class="header header-trans custom">
        <nav class="navbar navbar-expand-lg header-nav no-border">
          ...
          <ul class="nav header-navbar-rht right-menu">
            ...
            <li class="nav-item">
              <router-link class="nav-link header-login white-bg" to="/login"><i class="fas fa-user-circle mr-2"></i>login</router-link>
            </li>
            <li class="nav-item">
              <router-link class="nav-link header-login" to="/login"><i class="fas fa-lock mr-2"></i>Sign up</router-link>
            </li>
          </ul>
        </nav>
      </header>
